...
from ..heads.sr_rensnet_transformer import Transformer, LayerNorm, PositionwiseFeedForward, MultiHeadedAttention
...
class TBSRN(nn.Module):
    def __init__(self, in_channels=3, scale_factor=2, width=128, height=32, STN=True, srb_nums=5, mask=False,
                 hidden_units=32, infer_mode=False):
        super().__init__()
        in_planes = 3
        if mask:
            in_planes = 4
