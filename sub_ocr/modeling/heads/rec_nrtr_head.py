...
class Transformer(nn.Module):
    ...
    def __init__(self,
        ...
        if custom_encoder is not None:
            ...
            if num_encoder_layers > 0:
                encoder_layer = TransformerEncoderLayer(d_model, nhead, dim_feedforward, attention_dropout_rate,
        ...
        if custom_decoder is not None:
            ...
            decoder_layer = TransformerDecoderLayer(d_model, nhead, dim_feedforward, attention_dropout_rate,
                                                    residual_dropout_rate)
    ...
    def forward_beam(self, images):
        ...
        def collate_active_info(src_enc, inst_idx_to_position_map, active_inst_idx_list):
            ...
            active_src_enc = collect_active_part(src_enc.permute(1, 0, 2), active_inst_idx, n_prev_active_inst,
                                                 n_bm).permute(1, 0, 2)
        ...
        with torch.no_grad():
            ...
            for len_dec_seq in range(1, 25):
                ...
                active_inst_idx_list = beam_decode_step(inst_dec_beams, len_dec_seq, src_enc_copy,
