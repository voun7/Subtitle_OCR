...
class GSRM(nn.Module):
    def __init__(self, in_channels, char_num, max_text_length, num_heads, num_encoder_tus, num_decoder_tus,
                 hidden_dims):
        super().__init__()
        self.char_num = char_num
        self.max_length = max_text_length
    ...
    def forward(self, inputs, gsrm_word_pos, gsrm_slf_attn_bias1, gsrm_slf_attn_bias2):
        ...
        gsrm_feature2 = F.pad(gsrm_feature2, [0, 0, 0, 1, 0, 0], value=0.)
...
class SRNHead(nn.Module):
    ...
    def forward(self, inputs, others):
        ...
        gsrm_feature, word_out, gsrm_out = self.gsrm(pvam_feature, gsrm_word_pos, gsrm_slf_attn_bias1,
                                                     gsrm_slf_attn_bias2)
