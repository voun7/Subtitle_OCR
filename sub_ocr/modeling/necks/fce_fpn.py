...
class ConvNormLayer(nn.Module):
    def __init__(self, ch_in, ch_out, filter_size, stride, groups=1, norm_type='bn', norm_decay=0., norm_groups=32,
                 lr_scale=1., freeze_norm=False, initializer=None):
        super().__init__()
...
class FCEFPN(nn.Module):
    ...
    def forward(self, body_feats):
        ...
        for i in range(1, num_levels):
            lvl = num_levels - i
            upsample = F.interpolate(laterals[lvl], scale_factor=2., mode='nearest')
